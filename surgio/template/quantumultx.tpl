...
static=🎵 Spotify, proxy, {{ getNodeNames(nodeList, customFilters.AmericanHighRate) }}, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Spotify.png
